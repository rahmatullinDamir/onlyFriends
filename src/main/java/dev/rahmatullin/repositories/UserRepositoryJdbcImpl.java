...
public class UserRepositoryJdbcImpl implements UserRepository {
    ...
    private static final String SQL_INSERT_TO_USER_PROFILE = "INSERT INTO user_profile (name, surname, age, avatar_image_id, password) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public Optional<User> findById(Long id) throws SQLException {
        ...
        if (resultSet.next()) {
            return Optional.of(new User(resultSet.getLong(1), resultSet.getInt("age"),
                    ...
                    resultSet.getString("password"), resultSet.getLong("avatar_image_id")
            ));
        }
